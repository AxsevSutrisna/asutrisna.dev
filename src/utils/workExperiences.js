...
const normalizeEmploymentType = (value) =>
  EMPLOYMENT_TYPES.includes(value) ? value : DEFAULT_EMPLOYMENT_TYPE
...
export const normalizeWorkExperience = (experience) => {
  ...
  return {
    ...
    employment_type: normalizeEmploymentType(experience.employment_type),
    location: experience.location || "",
    start_month: toNumberOrNull(experience.start_month) || 1,
    start_year:
      toNumberOrNull(experience.start_year) || new Date().getFullYear(),
...
export const validateWorkExperienceForm = (form) => {
  ...
  if (!EMPLOYMENT_TYPES.includes(form.employment_type))
