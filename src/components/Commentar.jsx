...
const Comment = memo(({ comment, formatDate, isPinned = false}) => (
 ...
 ?'bg-[#0f172a] border-indigo-500/30 hover:bg-[#0f172a] hover: hover:'
...
const Komentar = () => {
 ...
 return (
 <div className="w-full bg-[#0f172a] rounded-2xl backdrop-blur-xl shadow-xl" data-aos="fade-up" data-aos-duration="1000">
