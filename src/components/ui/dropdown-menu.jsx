...
function DropdownMenuSubContent({
 ...
 className={cn(
"z-50 min-w-[8rem] overflow-hidden rounded-xl border-2 border-[color:var(--color-button-outline)] bg-[#0d0d22] p-1 font-medium text-gray-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in- data-[side=left]:slide-in- data-[side=right]:slide-in- data-[side=top]:slide-in-",
 className,
 )}
 {...props}
 />
