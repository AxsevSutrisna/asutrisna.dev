...
const DEFAULT_ICON = 'data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSIxMiIgaGVpZ2h0PSIxMiI+PGNpcmNsZSBjeD0iNiIgY3k9IjYiIHI9IjEuMiIgZmlsbD0id2hpdGUiLz48L3N2Zz4=';
...
const ProfileCardComponent = ({
  ...
  const cardStyle = useMemo(
    () => ({
      '--icon': iconUrl ? `url(${iconUrl})` : `url("${DEFAULT_ICON}")`,
  ...
  const shineStyle = {
    ...
    maskMode: 'luminance',
    maskRepeat: 'repeat',
    maskSize: iconUrl ? '150%' : '12px 12px',
  ...
  return (
    ...
    >
      {behindGlowEnabled && (
        <div
          className="absolute inset-0 z-0 pointer-events-none transition-opacity duration-200 ease-out animate-pulse-slow"
          style={{
        ...
        >
          ...
          >
            ...
            <div
              ...
              style={{
                transform:
                  'translate3d(calc(var(--pointer-from-left) * -6px + 3px), calc(var(--pointer-from-top) * -6px + 3px), 10px)',
                mixBlendMode: 'luminosity',
                gridArea: '1 / -1',
                borderRadius: cardRadius,
                pointerEvents: 'none'
            ...
            {yearsOfExperience !== undefined && (
              <div
                className="absolute bottom-6 right-6 bg-[#161b22]/90 border border-white/10 rounded-2xl p-4 shadow-2xl flex flex-col items-center justify-center transition-all duration-300 hover:border-white/20 hover:scale-105 select-none"
                style={{
