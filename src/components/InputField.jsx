...
const InputField = ({ field, label, icon: Icon, formData, handleChange}) => {
 ...
 focus:outline-none focus:ring-2 focus:ring-theme-primary-dark focus:ring-offset-2 
 focus:ring-offset-[#1c1e26] transition-all duration-300 peer
 `;

 const hoverFocusClasses = isFocused
 ?"shadow-[0_4px_12px_rgba(99,102,241,0.4)] border-theme-primary-dark"
 :"border-white/20 hover:border-theme-primary-dark";
 ...
 {/* Icon and Label */}
 <div className="absolute left-4 top-4 flex items-center space-x-2 text-gray-400 transition-colors group-hover:text-theme-primary-dark">
 ...
 peer-focus:top-2 peer-focus:translate-y-0 peer-focus:text-theme-primary-dark peer-focus:text-sm
 `}
 >
 {label}
 </label>
 ...
 ${isFocused ?"border-theme-primary-dark" :"border-transparent"}
 `}
 ></div>
 </div>
 );
