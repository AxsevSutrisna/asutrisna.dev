...
export default function PresenceWidget() {
 ...
 {/* Glass Card */}
 <div className={`relative backdrop-blur-md bg-[#0f172a] ${colors.bg} rounded-xl border ${colors.border} ${colors.glow} shadow-lg hover:shadow-xl hover:scale-[1.02] transition-all duration-300`}>
