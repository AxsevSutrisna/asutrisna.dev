...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const formSubmitUrl =
        "https://formsubmit.co/ajax/asepsutrisnasp@gmail.com"
      const submitData = {
        name: formData.name,
      ...
      pushToast("success", "Pesan Anda telah berhasil dikirim langsung ke email.")
        ...
        >
          <div>
            ...
            >
              ...
              consulting, and full-time opportunities. Drop me a line if you're
              looking for a developer who productizes code.
            </p>
