...
const resolveDriveDownloadUrl = (url) => {
  ...
  const directFileMatch = value.match(
...
export default function CVPage() {
  ...
  const orderedSocialLinks = useMemo(() => {
    ...
    return items.sort((left, right) => {
      ...
      return String(left.display_name || left.platform || "").localeCompare(
        String(right.display_name || right.platform || "")
      )
    })
  }, [socialLinks])
  ...
  const socialButtons = useMemo(() => {
    return orderedSocialLinks.map((link) => {
      const platform = String(
        link.icon || link.platform || link.display_name || "external"
      ).toLowerCase()
    ...
    <div className="px-[5%] md:px-[10%] pb-24">
      <Helmet>
        ...
        <meta
          ...
          content={
            profile.description ||
            "Curriculum Vitae and career overview of Muhammad Ikhwan Fathulloh."
          }
        />
      </Helmet>
                    ...
                    >
                      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                        <div className="space-y-2">
                          ...
                          <p className="text-sm font-medium text-[color:var(--color-primary-light)]">
                            {experience.company}
                          </p>
                      ...
                      {experience.description ? (
                        <div className="mt-4">
                          {renderBullets(experience.description)}
                        </div>
                      ) : null}
                    ...
                    >
                      ...
                      <div className="mt-3 space-y-2 text-sm text-gray-400">
                        ...
                        {education.description ? (
                          <div>{renderBullets(education.description)}</div>
                        ) : null}
                      </div>
                    </div>
                  ))
                  ...
                  groupedSkills.map((group) => (
                    ...
                    >
                      <div className="mb-3 flex items-center justify-between gap-3">
                        <h3 className="text-sm font-semibold uppercase tracking-[0.22em] text-gray-300">
                          {group.category}
                        </h3>
                        <Badge
                          variant="neutral"
