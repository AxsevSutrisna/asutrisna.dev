  ...
  return (
    <div className="relative group">
      ...
      <Card className="relative h-full p-5 sm:p-6 group-hover:border-white/30 transition-all duration-500">
          ...
          <div className="mt-5 relative">
            ...
            >
              ...
              {!isExpanded && isTruncated && (
                <div className="absolute bottom-0 left-0 right-0 h-24 bg-[#0f172a] (--color-backdrop-base)] pointer-events-none" />
              )}
            </div>
        ...
        <div className="absolute right-0 top-0 h-full w-px bg-[#0f172a]" />
      </Card>
    </div>
  )
}
...
const WorkExperienceSection = () => {
  const { workExperiences: experiences, loading } = useExperienceData()
  ...
  return (
    <section
      id="WorkExperience"
      className="md:px-[10%] px-[5%] w-full bg-[var(--color-backdrop-base)] overflow-hidden py-12 md:py-24"
