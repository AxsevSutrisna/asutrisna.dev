      ...
      <div className="min-h-screen flex items-center justify-center px-4">
        <div className="w-full max-w-md">
          <div className="relative group">
            <div
              className="absolute -inset-0.5 rounded-2xl blur opacity-30 group-hover:opacity-50 transition duration-700"
              style={{
                background:
            ...
            <Card className="relative p-8 space-y-7 bg-[color:var(--color-backdrop-base)]">
              ...
              <form onSubmit={handleLogin} className="space-y-4">
                ...
                <Button
                  type="submit"
                  disabled={loading}
                  className="w-full mt-1 group/btn h-12 cursor-target"
                >
                  {loading ? (
