...
export default function Comments() {
 ...
 ?"bg-[#0f172a] border border-indigo-500/35 text-white font-medium"
 ...
 {/* Avatar */}
 <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-[#0f172a] border border-white/10 flex items-center justify-center shrink-0">
 <img
