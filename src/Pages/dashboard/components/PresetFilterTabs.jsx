...
const PresetFilterTabs = ({
 ...
 className={`cursor-target inline-flex items-center gap-1.5 px-4 py-2 rounded-xl text-sm font-medium border transition-all duration-200 select-none no-neo
 ${isActive
